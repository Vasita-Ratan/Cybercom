...
if(isset($_POST['user_text']) && ! empty($_POST['user_text']))
{
	 ...
	 $user_text_lc = strtolower($user_text);
	 //$string_new = str_replace($find, $replace, $user_text_lc);
	  $string_new = str_ireplace($find, $replace, $user_text_lc);//capital latters ingnoring using str_ireplace
