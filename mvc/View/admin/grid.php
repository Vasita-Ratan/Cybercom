                        ...
                        ?>
                            ...
                            ?>
                                <tr >
                                    ...
                                    <th><a href="<?php echo $this->getUrl()->getUrl('form', NULL, ['id' => $value->adminId]); ?>"><i  class="fa fa-edit" style="color:#09e66c ;font-size:20px"></i></a></th>
                                    <th><a href="<?php echo $this->getUrl()->getUrl('delete', NULL, ['id' => $value->adminId]); ?>"><i class="fa fa-trash" style="color: #e60909 ; font-size:20px"></i></a></th>
                                </tr>
                        <?php }
                        } ?>
                    </tbody>
