...
<?php 
Mage::getController("Controller_GroupPrice");
$groupPrice = $this->getGroupPrices();
 ?>
    <div class="container">
                        ...
                        <table class="highlight">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <input type="text" name="groupPrice[<?php echo $rowStatusData; ?>][<?php echo $value->groupId ?>]" value="<?php echo $value->groupPrice;  ?>"> 
                                        </td>
                                    </tr>
                            </tbody>
                            <?php endforeach; ?>
